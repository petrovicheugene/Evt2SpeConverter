...
; !!!
; !!!
#define evt2speSettingsWidowName "evt2spe Settings"
#define evt2speSettingsExeName "evt2speSettings.exe"
#define evt2speAppName "Evt2SpeSettings"
#define MyAppName "Evt2SpeContext"
#define MyAppVersion "2.0.0"
#define MyAppFullVersion "2.0.0.r"
#define MyAppExeName "evt2spe.exe"
#define MyAppExeBaseName "evt2spe"
#define MyAppWindowName "Evt2Spe" 
...
;#define QtLibFolder "D:\QtProjects\StreamControl\Qt-5.14.1-Lib\" 
;#define DocFolder "D:\QtProjects\StreamControl\Qt-5.14.1-StreamControl\Doc\" 
...
AppCopyright = Copyright © TechnoAnalyt Ltd. 2020. All rights reserved.
AppId={{ED0363D8-5A03-4BC8-9804-5AAE1E98F6A1}
...
[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"; LicenseFile: "{#InnoSetupFolder}licenseEn.txt"
Name: "russian"; MessagesFile: "compiler:Languages\Russian.isl"; LicenseFile: "{#InnoSetupFolder}licenseRu.txt"
...
[CustomMessages]
;QtPage
english.QtPageCaption=Select Destination Lcation of Qt{#QtVersion} Library
...
; open with the type of file .evt
Root: HKCR; Subkey: ".evt"; ValueType: string; ValueData: "evtfile"; Flags: uninsdeletekeyifempty
Root: HKCR; Subkey: "evtfile"; Flags: uninsdeletekeyifempty 
Root: HKCR; Subkey: "evtfile\Shell"; Flags: uninsdeletekeyifempty 
Root: HKCR; Subkey: "evtfile\Shell\evt2spe"; ValueType: string; ValueData: "Convert to .SPE"; Flags: uninsdeletekeyifempty
Root: HKCR; Subkey: "evtfile\Shell\evt2spe\command"; ValueType: string; ValueData: "{app}\{#MyAppExeName} %1"; Flags: uninsdeletekey
...
;Source: "{#SourceFolder}StreamControl_ru.qm"; DestDir: "{app}"; Flags: ignoreversion
;Source: "{#SourceFolder}qtbase_ru.qm"; DestDir: "{app}"; Flags: ignoreversion
;Source: "{#SourceFolder}scvn.hex"; DestDir: "{app}"; Flags: ignoreversion
...
Name: "{group}\{#evt2speSettingsWidowName}"; Filename: "{app}\{#evt2speSettingsExeName}"
Name: "{group}\{cm:ProgramOnTheWeb,{#MyAppPublisher}}"; Filename: "{#MyAppURL}" 
Name: "{group}\{cm:UninstallProgram,{#evt2speSettingsWidowName}}"; Filename: "{uninstallexe}"
...
[Run]
Filename: "{app}\{#evt2speSettingsExeName}"; Parameters:"-platformpluginpath ""{code:GetQtFolder}""" ;Description: "{cm:LaunchProgram,{#StringChange(evt2speAppName, '&', '&&')}}"; Flags: shellexec postinstall skipifsilent;
